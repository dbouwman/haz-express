...
var assetsManagerMiddleware = assetManager({
	'js':{
		...
		, 'path': './public/javascripts/'
		        , 'dataType': 'javascript'
		        , 'files': ['zepto.js','microevent.js','SocketWrapper.js', 'leaflet.js', 'AgsDynamicLayer.js', 'Map.Controller.js']
    }, 
	'js-mobile':{
		'route':/\/js\/app.mobile.js/
		, 'path': './public/javascripts/'
		        , 'dataType': 'javascript'
		        , 'files': ['zepto.js','microevent.js','SocketWrapper.js', 'leaflet.js','AgsDynamicLayer.js','move.js', 'Map.Mobile.Controller.js']
     },  
